import 'package:employeeapp/CompanySide/HomeSection/MakePaymentToEmployee/selectEmployeeToPaysalary.dart';
...
class SelectZoneToPEmployeePayment1 extends StatelessWidget {
  const SelectZoneToPEmployeePayment1({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              onTap: () => Get.to(
                SelectEmployeeToCheckSalarySetails(),
