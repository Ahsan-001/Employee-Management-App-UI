...
class BarcelonaView extends StatefulWidget {
  const BarcelonaView({Key? key}) : super(key: key);

  @override
  State<BarcelonaView> createState() => _BarcelonaView();
}

class _BarcelonaView extends State<BarcelonaView>
