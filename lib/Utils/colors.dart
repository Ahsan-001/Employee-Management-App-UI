...
const kMainColor = Color(0xff501CC8);
// const kSecondaryColor = Color(0xff501CC8);
...
const backgroundColor = Color(0xff141A32);
...
MaterialColor kPrimaryColor = MaterialColor(0xFFC81C78, color);
